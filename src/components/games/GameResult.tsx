...
export default function GameResult({ icon, iconBg, title, stars, score, subtitle, accentColor = 'bg-coral', children, onReset }: Props) {
  ...
  return (
    ...
    >
      <div className={`w-20 h-20 rounded-3xl ${iconBg} flex items-center justify-center`}>
        {icon}
      </div>
      ...
      <p className="text-[36px] font-extrabold text-gradient-coral leading-none">{score}</p>
