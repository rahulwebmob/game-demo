...
export default function SleepOverlay({ avatar, onStartEyeCheck, onClose }: Props) {
  ...
  return (
    <motion.div
      ...
      style={{
        background: 'linear-gradient(170deg, #0c1222 0%, #162036 35%, #1a2744 65%, #0f1829 100%)',
      }}
    >
      {/* Close / Skip button */}
      <motion.button
      ...
      >
        ...
        <motion.div
          ...
          style={{ background: 'radial-gradient(circle, rgba(123,167,181,0.12) 0%, transparent 70%)' }}
        ...
        >
          ...
          <motion.div
            ...
            style={{ background: 'linear-gradient(180deg, transparent 50%, rgba(15,24,41,0.25) 100%)' }}
        ...
        <motion.span
          ...
          style={{ fontSize: 26, color: 'rgba(253,224,71,0.55)', right: -14, top: -8 }}
          animate={{
            y: [0, -40, -85],
            x: [0, 8, 18],
            opacity: [0, 0.6, 0],
          ...
          transition={{ duration: 3.2, repeat: Infinity, ease: 'easeOut', delay: 0 }}
        >
          Z
        </motion.span>
        ...
        <motion.span
          className="absolute font-extrabold pointer-events-none select-none"
          style={{ fontSize: 20, color: 'rgba(253,224,71,0.4)', right: -24, top: -20 }}
          animate={{
            y: [0, -50, -100],
            x: [0, 12, 28],
            opacity: [0, 0.5, 0],
          ...
          transition={{ duration: 3.6, repeat: Infinity, ease: 'easeOut', delay: 0.9 }}
        >
          z
        </motion.span>
        ...
        <motion.span
          className="absolute font-extrabold pointer-events-none select-none"
          style={{ fontSize: 14, color: 'rgba(253,224,71,0.28)', right: -30, top: -28 }}
          animate={{
            y: [0, -55, -115],
            x: [0, 15, 35],
            opacity: [0, 0.4, 0],
          ...
          transition={{ duration: 4.0, repeat: Infinity, ease: 'easeOut', delay: 1.8 }}
        >
          z
        </motion.span>
      </motion.div>
      ...
      >
        ...
        <span className="text-[13px] font-semibold text-white/35">0 / 5 Energy</span>
      </motion.div>
