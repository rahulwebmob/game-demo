...
type CalendarHeartProps = IconProps<keyof typeof animations>;
...
function IconComponent({ size, ...props }: CalendarHeartProps) {
...
function CalendarHeart(props: CalendarHeartProps) {
